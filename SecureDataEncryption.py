...
# from base64 import urlsafe_b64encode  # Add this import
...
#     return urlsafe_b64encode(key)  # This returns a 44-byte base64-encoded string


# def hash_password(password):
#     return hashlib.pbkdf2_hmac('sha256000', password.encode(), SALT, 100000).hex()
...
#         st.error(f"Too many failed attempts. please wait {remaining} second.")
#         st.stop()
...
#     if not st.authenticated_user:
#         st.warnig("Please Login first.")
#     else:
